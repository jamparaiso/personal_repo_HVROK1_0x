...
local function NextButtonEventHandler(event)
	...
	local function BackButtonEventHandler(event)
		...
		myData.playSound("tap")
			...
			storyboard.gotoScene("scene6", "slideRight", 500)
			return true;
		end
	end
...
function scene:createScene( event )
	...
	local background = display.newImage("Images/Fifth.png")
	background.x = display.contentCenterX
	background.y = display.contentCenterY

	local background2 = display.newImage("Images/Sixth.png")
	background2.x = display.contentCenterX
	background2.y = display.contentCenterY

	local background3 = display.newImage("Images/Seventh7.png")
